...
/**
 * Controlador para compras de stands por editoriales.
 */
public class CompraController {
    ...
    public CompraController(StandRepository standRepository, PublisherRepository publisherRepository) {
    ...
    public Response<String> comprarStands(List<String> idsStands, List<String> editorialesTexto) {
        ...
        for (String texto : editorialesTexto) {
            ...
            nits.add(nit);
            Publisher editorial = publisherRepository.buscarPorNit(nit);
            if (editorial == null) {
        ...
        standRepository.notifyObservers();
        publisherRepository.notifyObservers();
